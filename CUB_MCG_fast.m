...
tot=0; List=randperm(11788); load('Cluster.mat');
fn=fopen('cub_MCG_Fast_Coarse_finetune_train.txt','w'); 
for i=1:11788
  if Split(List(i),:)==1 % 1 for train && 0 for test
  	...
  	%candidates_scg = im2mcg(im,'fast'); save(['/home/wangdequan/Fine-Grained/datasets/CUB_200_2011/MCG_fast/' MatList{List(i)}],'candidates_scg','-v7.3');
  	load(['/home/wangdequan/Fine-Grained/datasets/CUB_200_2011/MCG_fast/' MatList{List(i)}]);
